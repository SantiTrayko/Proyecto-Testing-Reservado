 ...
 */
//FUNCIONALIDAD REFACTORIZADA
var restaurant = this.restaurantes.find(function(restaurant){
    return restaurant.id === id;
});

return restaurant !== undefined? restaurant : "No se ha encontrado ningún restaurant";
}

function eliminarElementosRepetidos (array){
    
    var resultado = array.filter(function (elem, index, self) {
...
Listado.prototype.obtenerCiudades = function () {
    ...
    return eliminarElementosRepetidos(ciudades).sort();
